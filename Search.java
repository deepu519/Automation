...
{
Set<String> window = driver.getWindowHandles();Iterator<String>it = window.iterator();
Thread.sleep(2000);
String parentId = it.next();
String childId = it.next();
driver.switchTo().window(childId);
Assert.assertTrue(driver.findElement(By.tagName("h2")).isDisplayed());
driver.findElement(By.id("inputFirstName")).sendKeys("deepthi");
driver.findElement(By.xpath("(//*[@id='inputFirstName'])[2]")).sendKeys("kaluvapalli");
driver.findElement(By.id("inputEmail")).sendKeys("Dk@gmail.com");
driver.findElement(By.id("inputPassword")).sendKeys("Deepu@123");
...
sle.selectByVisibleText("Tamil Nadu");
driver.findElement(By.id("inputZip")).sendKeys("600002");
...
ro.keyRelease(KeyEvent.VK_ENTER);Thread.sleep(2000);
}
}
